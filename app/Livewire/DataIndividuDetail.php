...
class DataIndividuDetail extends Component {
    ...
    public function mount($id) {
        ...
        // Dummy data dengan beberapa variasi
        if ($id === '3201010101010002') {
            // Data dummy dengan status cerai
            $this->resident = (object) [
                ...
                'tanggal_perkawinan'      => '2000-05-15',
                'tanggal_perceraian'      => '2010-12-20',
                ...
                'pendidikan'              => (object) ['nama' => 'TAMAT SLTA / SEDERAJAT'],
                'pekerjaan'               => (object) ['nama' => 'Guru'],
                'hubungan_keluarga'       => (object) ['nama' => 'KEPALA KELUARGA'],
                'keluarga_dalam_kk'       => [
                    (object) ['hubungan' => 'KEPALA KELUARGA', 'nama_anggota' => 'SRI LESTARI', 'nik' => '3201010101010002'],
                    (object) ['hubungan' => 'ANAK', 'nama_anggota' => 'RINA LESTARI', 'nik' => '3201010101010006'],
                ],
            ];
        } else {
            // Data dummy default (status kawin)
            $this->resident = (object) [
